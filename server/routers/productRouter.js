...
productRouter.post("/register", upload.single("photo"), (req, res)=>{
    ...
    s3.upload(params, (err, data)=>{
        ...
        db.query("INSERT INTO producttbl (category, name, price, description, inventory, photo, reviewCount, averageRating) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [category, name, price, description, inventory, photo, 0, 0], (err, result)=>{
            if (err) {
